...
namespace ITI.Luxorna.Repositories.Context
{
    public class EntitiesContext : DbContext
    {
        ...
        public virtual DbSet<ResturantItemSize> ResturantItemSizes { get; set; }
        public virtual DbSet<ResturantMenuItem> ResturantMenuItems { get; set; }
        ...
        public virtual DbSet<ResturantPackageMenuItem> ResturantPackageMenuItems { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new ResturantItemSizeConfiguration());
            modelBuilder.Configurations.Add(new ResturantMenuItemConfiguration());
            ...
            modelBuilder.Configurations.Add(new ResturantPackageMenuItemConfiguration());
