...
namespace ITI.Luxorna.Repositories
{
    public class UnitOfWork
    {
        ...
        public GenericRepository<ResturantItemSize> ResturantItemSizeRepo { get; set; }

        public GenericRepository<ResturantMenuItem> ResturantMenuItemRepo { get; set; }

        public GenericRepository<ResturantPackageMenuItem> ResturantPackageMenuItemRepo { get; set; }
            ...
            GenericRepository<Country> countryRepo,
             ...
             GenericRepository<MuseumPacakge> museumPackageRepo,
              ...
              GenericRepository<ResturantImage> resturantImageRepo,
               ...
               GenericRepository<ResturantItemSize> resturantItemSizeRepo,
               GenericRepository<ResturantMenuItem> resturantMenuItemRepo,
               GenericRepository<ResturantPackageMenuItem> resturantPackageMenuItemRepo,
                   ...
                   GenericRepository<User> userRepo)
        {
            ...
            ResturantItemSizeRepo = resturantItemSizeRepo;
            ResturantItemSizeRepo.Context = Context;
            ResturantMenuItemRepo = resturantMenuItemRepo;
            ResturantMenuItemRepo.Context = Context;
            ResturantPackageMenuItemRepo = resturantPackageMenuItemRepo;
            ResturantPackageMenuItemRepo.Context = Context;
